...
@Component ({
  ...
  template: `
    <div class="food-form">
      <h3>Did you just eat something? Add it here!</h3>
      ...
      <br>
      <button (click)="addFood(newFoodName, newFoodDescription, newFoodCalories)" class="btn-info btn-lg add-button">Track My Food, I Guess</button>
    </div>
  `
})
